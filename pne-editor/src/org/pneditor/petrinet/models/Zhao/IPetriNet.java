package org.pneditor.petrinet.models.Zhao;
...
public interface IPetriNet {
	 ...
	 * 
	 * @return id: id of the new created place
	 */
	public String addPlace(int n);
	 ...
	 * Add a transition.
	 * 
	 * @return id: id of the new created transition
	 */
	 ...
	 * 
	 * @return id: id of the new created arc
	 */
	public String addArc(String sourceId, String targetId, int weight);
	 ...
	 * @param targetId: id of the target object
	 * 
	 * @return id: id of the new created empty arc
	 */
	public String addEmptyArc(String sourceId, String targetId);
	 ...
	 * @param targetId: id of the target object
	 * 
	 * @return id: id of the new created zero arc
	 */
	public String addZeroArc(String sourceId, String targetId);
